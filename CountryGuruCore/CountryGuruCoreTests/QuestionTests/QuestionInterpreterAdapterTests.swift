//
//  QuestionInterpreterAdapterTests.swift
...
struct QuestionInterpreterAdapterTests {
    @Test
    func throws_on_bad_question_interpretation() async throws {
    ...
    @Test
    func creates_country_capital_question_successfully() async throws {
